                ...
                <div
                    ...
                    <div class="flex-auto px-4 lg:px-10 py-10 pt-0 mt-3">
                        <div class="w-full xl:w-full mb-12 xl:mb-0 px-4 mt-2">
                            <form
                                @submit.prevent="form.post(route('portfolio.skill-type-store'))">
                                <input
                                ...
                                >
                                <InputError :message="form.errors.skill_type" class="mt-2"/>
                                <PrimaryButton class="mt-4">Save skill type name!</PrimaryButton>
