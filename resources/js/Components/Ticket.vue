    ...
    <div class="p-6 flex space-x-2">
        ...
        <div class="flex-1">
            <div class="flex justify-between items-center">
                ...
                <Dropdown v-if="ticket.user.id === $page.props.auth.user.id">
                    <template #trigger>
                        <button>
                    ...
                    <template #content>
                        ...
                        <DropdownLink as="button" :href="route('tickets.destroy', ticket.id)" method="delete">
                            Delete
                        </DropdownLink>
                    </template>
                </Dropdown>
            ...
            <form v-if="editing"
                  @submit.prevent="form.put(route('tickets.update', ticket.id), { onSuccess: () => editing = false })">
            ...
            <p v-else class="mt-4 text-lg text-gray-900">{{ ticket.message }}</p>
        </div>
    </div>
</template>
