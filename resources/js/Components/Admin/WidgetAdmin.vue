            ...
            <div class="grid grid-cols-3">
                <div>
                    ...
                    <small class="font-normal leading-normal mt-0 mb-4 text-blueGray-800">
                        Category: {{ widget.widget_category_id }}
                    </small>
                    ...
                    <p class="text-base font-light leading-relaxed mt-0 mb-4 text-emerald-800" v-html='widget.content'/>
                </div>
                <div class="flex flex-wrap justify-center">
                    <div class="w-10/12 sm:w-8/12 px-4">
                        <img :src="widget.widget_path" alt="..."
                             class="shadow rounded max-w-full h-auto align-middle border-none"/>
                    </div>
                </div>
                <div>
                    <div style="float:right">
                        <Link :href="route('admin.widget-update', widget.id)" method="get">
                            <button
                        ...
                        <Link :href="route('admin.post-destroy', widget.id)" method="delete" as="button">
                            <button
