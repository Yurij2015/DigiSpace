---
type: Behaviour Spec
title: "AI Content Generator & Translator (Configurable Entities & Filament Form Integration)"
description: "Configurable multi-entity content generation engine with entity descriptions, attribute mapping, SEO field population, polymorphic attempt tracking, AI translation from English base with adapted and literal modes, and Filament 5 modal action."
tags: [admin, filament, ai, content-generator, translation, posts, pages, seo]
status: proposed
...
sources:
  ...
  - id: page-model
    resource: repo://app/Models/Page.php
---
