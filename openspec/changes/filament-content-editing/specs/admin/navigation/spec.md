...
description: "How control-panel resources are grouped and ordered so that content management is the first thing an editor sees."
tags: [admin, filament, navigation]
status: proposed
...
sources:
  ...
  - id: post-resource
    resource: repo://app/Filament/Resources/Posts/PostResource.php
---
