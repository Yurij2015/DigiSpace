---
type: Behaviour Spec
title: "Public site — Accessibility baseline"
description: "Accessible names for images, icon-only links and controls in the public layout; no stray text nodes in navigation."
tags: [public-site, accessibility, a11y, ux]
status: proposed
last_verified_at: 2026-09-14
sources:
  - id: header
    resource: repo://resources/views/components/header.blade.php
  - id: header-navbar-content
    resource: repo://resources/views/components/header-navbar-content.blade.php
  - id: footer
    resource: repo://resources/views/components/footer.blade.php
  - id: our-projects
    resource: repo://resources/views/components/our-projects.blade.php
---
