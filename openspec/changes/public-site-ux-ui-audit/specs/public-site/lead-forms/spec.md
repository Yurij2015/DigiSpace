---
type: Behaviour Spec
title: "Public site — Lead forms feedback"
description: "Contact and subscribe forms keep the visitor's input, show per-field errors, confirm success and use localized labels."
tags: [public-site, forms, contact, subscribe, ux]
status: proposed
last_verified_at: 2026-09-14
sources:
  - id: contact-form
    resource: repo://resources/views/components/contact-form.blade.php
  - id: contact-controller
    resource: repo://app/Http/Controllers/ContactController.php
  - id: footer
    resource: repo://resources/views/components/footer.blade.php
  - id: subscriber-controller
    resource: repo://app/Http/Controllers/SubscriberController.php
---
